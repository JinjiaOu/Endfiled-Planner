...
struct ProductionOptimizerView: View {
        ...
        NavigationStack {
            ZStack {
                ...
                Canvas { context, size in
                    ...
                    context.stroke(
                        path,
                        with: .color(Color(red: 0.9, green: 0.5, blue: 0.2).opacity(0.1)),
                        lineWidth: 0.5
                    )
                }
                .ignoresSafeArea()
                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            HStack(alignment: .top) {
                                VStack(alignment: .leading, spacing: 8) {
                                    ...
                                    Text("Production Optimizer Module")
                        ...
                        VStack(spacing: 16) {
                            Image(systemName: "hammer.fill")
                                .font(.system(size: 60))
                                .foregroundColor(Color(red: 0.9, green: 0.5, blue: 0.2).opacity(0.5))
