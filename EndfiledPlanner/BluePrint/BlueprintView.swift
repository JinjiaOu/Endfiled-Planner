                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 16) {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                BlueprintFeatureItem(text: "蓝图码存储管理", color: Color(red: 0.2, green: 0.6, blue: 0.9))
                                BlueprintFeatureItem(text: "蓝图码分类整理", color: Color(red: 0.2, green: 0.6, blue: 0.9))
                                BlueprintFeatureItem(text: "蓝图码导入导出", color: Color(red: 0.2, green: 0.6, blue: 0.9))
                                BlueprintFeatureItem(text: "蓝图码快速分享", color: Color(red: 0.2, green: 0.6, blue: 0.9))
                            }
                            .padding(.top, 8)
                        }
                        .padding(30)
...
// 功能列表项
struct BlueprintFeatureItem: View {
    let text: String
    let color: Color
